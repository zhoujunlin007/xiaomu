...
public class LoginController implements CommunityConstant {
    ...
    public String register(Model model, User user) {
        Map<String, Object> map = userService.register(user);  // 注册成功返回空值
...
//                                            获取链接上的参数
    public String activation(Model model, @PathVariable("userId") int userId, @PathVariable("code") String code) {
        ...
        if (result == ACTIVATION_SUCCESS) {
            ...
            model.addAttribute("msg", "账户已激活，请勿重复激活。");
            model.addAttribute("target", "/index");
        }else {
    ...
    public String login(String username, String password, String code, boolean remeberme,
        ...
        if (map.containsKey("ticket")) {
            ...
            model.addAttribute("usernameMsg", map.get("usernameMsg"));  // 如果为空就添加失败
            model.addAttribute("passwordMsg", map.get("passwordMsg"));
            return "/site/login";
        }
